...
export default function BillDash() {
                                            ...
                                            >
                                                <Grid item>
                                                    ...
                                                    <Typography
                                                        ...
                                                        variant="h4"
                                                    >
                                                    {bill_count?.expected_amount&&bill_count?.expected_amount.total_amount__sum||0}
                                                    </Typography>
                                                </Grid>
                                                <Grid item>
                                                    <Avatar
                                            ...
                                            >
                                                <Grid item>
                                                    ...
                                                    <Typography
                                                        ...
                                                        variant="h4"
                                                    >
                                                    {bill_count?.collected_amount&&bill_count?.collected_amount.amount__sum ||0} 
                                                    </Typography>
                                                </Grid>
                                                <Grid item>
                                                    <Avatar
